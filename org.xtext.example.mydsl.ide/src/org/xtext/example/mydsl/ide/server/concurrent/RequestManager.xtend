...
package org.xtext.example.mydsl.ide.server.concurrent
...
class RequestManager {
	...
	def <U, V> CompletableFuture<V> runDryRun(()=>U nonCancellable, (CancelIndicator, U)=>V cancellable) {
		val cancelFuture = cancel()
		return submit(
			new DryRunRequest(nonCancellable, cancellable, cancelFuture)
		)
	}
...
@FinalFieldsConstructor
class DryRunRequest<U, V> extends AbstractRequest<V> {
